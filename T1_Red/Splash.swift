...
override func draw(_ rect: CGRect) {
    ...
    let p = CGRect(x:0,y:0,width:capture.size.width*1.123,height:capture.size.height*1.8)
    let ptwo = CGRect(x:100,y:0,width:(capture.size.width),height:capturetwo.size.height/1.73)
